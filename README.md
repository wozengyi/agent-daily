...
自动推荐每日最新大模型/Agent相关论文，数据源来自 arXiv 和 Hugging Face Daily Papers。

## 功能特性

- **今日推荐**：每日最新论文，按热度排序
- **最新论文**：最近 7 天内的所有匹配论文
- **往期论文**：**最近 20 年**历史归档论文（持续增长中），按年份分组，折叠展示
- **收藏功能**：本地收藏感兴趣的论文
...
- **自动更新**：GitHub Actions 每日自动构建，历史数据只追加永不删除，持续积累
...
- **定时运行**：每天 UTC 00:30 (北京时间 08:30) 自动执行抓取和构建
